        ...
        <div className="row align-items-start">
          ...
          <div className="col-8 justify-content-center text-center">
            ...
            <SectionSwitcher sections={sections} 
              nextSectionIndex={nextSection} btnFooterClick={btnFooterClick} 
              navBarClick={navBarClick} setNavBarClick={setNavBarClick} 
              setNextSection={setNextSection} currentSectionId={currentSectionId} 
