    ...
    <div className="App">
      <div className="my-container">
        ...
        <div className="col-12">
          <Footer total={total} nextSectionString={((nextSection === sections.length) ? "QUOTE" : sections[nextSection].name)} 
            nextSectionIndex={nextSection} limit={sections.length} navBarClick={navBarClick} btnFooterClick={btnFooterClick}
